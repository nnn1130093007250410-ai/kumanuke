...
const PHASE1_COUNTRIES = [
  ...
  },
  {
    ...
    nameJa: 'フィンランド',
    bears: ['Brown bear'],
    desc: '個体数1,800〜2,400頭（Luke 2024年調査）。公的機関による体系的な調査・管理が進んでいる。',
  },
  {
    slug: 'sweden',
    country: 'Sweden',
  ...
  },
  {
    ...
    nameJa: 'ノルウェー',
    bears: ['Brown bear'],
    desc: '2020年DNA調査で150頭を個体識別。Rovdataによる非侵襲的モニタリングが世界のモデルに。',
  },
  {
    slug: 'romania',
    country: 'Romania',
    ...
    nameJa: 'ルーマニア',
    bears: ['Brown bear'],
    desc: 'EU圏最大のヒグマ個体群（遺伝子調査で10,400頭超）。過去20年で26人死亡・274人重傷。政策が急務。',
  },
  {
    slug: 'slovenia',
    country: 'Slovenia',
    ...
    nameJa: 'スロベニア',
    bears: ['Brown bear'],
    desc: '2023年調査で737頭確認。EU LIFE DinPin Bearプロジェクト主導国。交通事故対策の先進事例。',
  },
  {
    slug: 'malaysia',
    country: 'Malaysia',
    ...
    nameJa: 'マレーシア',
    bears: ['Sun bear'],
    desc: 'IUCN危急種・サンベアの最大生息地。BSBCCがボルネオで保全活動を展開。森林破壊・密猟が課題。',
  },
  {
    slug: 'south-korea',
    country: 'South Korea',
    ...
    desc: '2004年から智異山でツキノワグマ復元プログラム実施。2024年に個体数約80頭・第4世代の自然繁殖を確認。',
  },
  {
    slug: 'india',
    country: 'India',
    ...
    nameJa: 'インド',
    bears: ['Sloth bear'],
    desc: '年間数百件のナマケグマ人身被害。ScienceDirect・PLOS ONE掲載の査読済み研究によるデータが蓄積。',
  },
]
