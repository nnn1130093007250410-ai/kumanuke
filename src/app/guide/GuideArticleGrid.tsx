...
const articles: {
  ...
  {
    slug: 'bear-translocation-technology',
    title: 'クマを殺さず共存する技術の最前線——学習放獣・GPS追跡・ベアドッグ',
    description: '「捕獲＝駆除」ではない。学習放獣（島根県再捕獲率18%）・GPS首輪追跡・ベアドッグによる追払いなど、日本と世界で実績が記録されている非致死的クマ管理の技術と現状を解説します。',
    tag: '技術・最前線',
    tagColor: '#0C5C3E',
    category: 'LAB',
  },
  {
    slug: 'people-facing-bears',
    title: 'クマと向き合う人たち——研究者・NPO・農家の現場',
    description: '山﨑晃司教授（東京農業大学）・坪田敏男教授（北海道大学）・NPOピッキオ・日本クマネットワーク——クマの研究・管理・保護の最前線で活動する実在の人物と組織を紹介します。',
    tag: '共存・人と現場',
    tagColor: '#1A5C2E',
    category: 'LAB',
  },
  {
    slug: 'bear-not-the-enemy',
    title: 'クマは悪くない。環境変化が生んだ「共存の危機」と私たちにできること',
    description: 'クマは本来、人を避ける臆病な生き物です。出没増加の背景には食料不足・里山の荒廃・気候変動があります。「クマが悪い」という誤解を解き、共存するための考え方と対策をわかりやすく解説します。',
    tag: '共存・考え方',
    tagColor: '#1A5C2E',
    category: 'LAB',
  },
