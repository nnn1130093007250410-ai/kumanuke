...
const AREAS: { pref: string; stores: Store[] }[] = [
  {
    ...
    stores: [
      ...
      { name: '（有）佐々木銃砲釣具店', addr: '〒086-1041 標津郡中標津町東1条北2丁目10', tel: '0153-72-2347' },
      { name: 'つり具の釣人 苫小牧店', addr: '〒053-0803 苫小牧市若草町1丁目5-3', tel: '0144-76-0097' },
    ],
  },
  {
    pref: '青森県',
  ...
  },
  {
    pref: '埼玉県',
    stores: [
      { name: 'つり具のブンブン 埼玉狭山店', addr: '〒350-1332 狭山市下奥富505-1', tel: '04-2946-7631' },
    ],
  },
  {
    pref: '千葉県',
  ...
  },
  {
    pref: '静岡県',
    stores: [
      { name: 'かめや釣具 清水店', addr: '〒424-0068 静岡市清水区長崎南町1-46', tel: '054-344-1191' },
      { name: 'かめや釣具 富士店', addr: '〒416-0951 富士市米之宮町30', tel: '0545-65-9141' },
    ],
  },
  {
    pref: '岐阜県',
    stores: [
      { name: 'つり具のブンブン 岐阜店', addr: '〒501-0471 本巣市政田1607', tel: '058-260-7371' },
    ],
  },
  {
    pref: '愛知県',
    stores: [
      { name: 'つり具のブンブン 名古屋小牧店', addr: '〒485-0046 小牧市堀の内5丁目144', tel: '0568-48-2377' },
    ],
  },
  {
    pref: '滋賀県',
    stores: [
      { name: 'つり具のブンブン びわ湖大津店', addr: '〒520-2145 大津市大将軍1-28-1', tel: '077-547-3701' },
    ],
  },
  {
    pref: '京都府',
    stores: [
      { name: 'つり具のブンブン 京都伏見店', addr: '〒612-8246 京都市伏見区横大路芝生1 エディオン伏見店2F', tel: '075-604-6930' },
    ],
  },
  {
    pref: '大阪府',
    stores: [
      { name: 'つり具のブンブン 高井田店', addr: '〒577-0063 東大阪市川俣1-15-29', tel: '06-6785-2937' },
    ],
  },
  {
    pref: '島根県',
    stores: [
      { name: 'かめや釣具 浜田店', addr: '〒697-0061 浜田市笠柄町67', tel: '0855-24-7077' },
    ],
  },
]
