...
const faqs = [
  ...
  },
  {
    ...
    a: '植物由来成分を主体としていますが、人やペットの肌・目・顔まわりへの直接噴射は避けてください。農作物への直接散布も避け、農地外周・周囲への使用にとどめてください。',
  },
  {
    q: '衣類や持ち物にスプレーしてもよいですか？',
    a: '衣類やザック・帽子などの携行品にもご使用いただけます。多量に散布して長時間放置するとシミになる場合がありますが、洗濯で落ちます。使用後は早めに洗濯してください。なお、人の肌・目・顔まわりへの直接噴射は避けてください。',
  },
  {
    q: '虫除けにもなりますか？',
    a: 'シトロネラをはじめ、虫が嫌うとされる植物由来の香り成分を高濃度に配合しています。アウトドアで虫が気になる場面にもお使いいただけます。',
  },
  {
    q: '熊以外の動物にも効果はありますか？',
  ...
  },
  {
    ...
    a: '使用期限の目安は、未開封で製造から約3年、開封後は約1年です。いずれも目安であり、保管状況や使用環境により変動する場合があります。製造日はパッケージ底面に記載しています。開封後はお早めに使い切り、色やにおいに変化を感じた場合は使用を中止してください。直射日光・高温多湿の場所を避け、冷暗所で保管してください。',
  },
]
