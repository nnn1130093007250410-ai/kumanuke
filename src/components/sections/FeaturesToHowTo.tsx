          ...
          <div>
            ...
            <div style={{ background: '#EFF5F0', border: '1px solid #C8DFC9', borderLeft: '3px solid #1F5C2E', borderRadius: '0 6px 6px 0', padding: '18px 18px', marginTop: 20 }}>
              <p style={{ fontSize: 13, color: '#143D1E', lineHeight: 1.8 }}>
                <strong>研究・参考情報：</strong>植物由来の成分が動物の忌避・採食行動に影響し得ることは、昆虫を対象とした研究で広く報告されているほか、哺乳類でも複数報告されています。例として、植物由来成分（精油・テルペン類）のげっ歯類への忌避可能性を整理したレビュー（Hansenら 2016, J. Chem. Ecol. 42(9)）、タンニン・植物油（ヒマシ油・ニンニク油・シナモン油）を配合した忌避剤がイノシシの採食行動を抑制したとする試験（Parkら 2024, J. Prev. Vet. Med. 48(3):189–192）、嗅覚を利用した忌避手法のシカへの効果を解析したレビュー（Guerisoli & Pereira 2020, J. Environ. Manage. 271）などがあります。ただし効果は天候・個体差・餌条件等で変動し、屋外では一定しないことも指摘されています。KUMANUKEはこうした一般的な知見を参考に開発されていますが、本製品そのものの効果や、クマを含むすべての状況・個体への忌避効果を保証・実証するものではありません。
              </p>
            </div>
          </div>
          <div>
